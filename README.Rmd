...
We can upload and download files to the Binder environment using the file explorer on the left of the interface (use the `r fa("upload")` button to upload files and right click on a file/folder and select "Download" to download it). 
